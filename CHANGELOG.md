...
- Corrected generated conversation `interaction_style` values from `single question` to `single questions` and updated validation accordingly.

## 0.8.4 - 2026-05-22

- Updated chatbot-connectors package version to 0.7.2

## 0.8.3 - 2026-05-21

- Updated chatbot-connectors package version to 0.7.1

## 0.8.2 - 2025-10-28

- Fixed the timeout in the LLM

## 0.8.1 - 2025-10-28

- Added a timeout to the LLM calls

## 0.8.0 - 2025-10-24

- Implemented retry logic with exponential backoff
- Implemented token bucket to avoid sending too many messages too fast
- Added delay between messages based on length of the message received and message to be send
- Added session cooldown between sessions that increases if there have been errors
