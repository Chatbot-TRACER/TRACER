...
def build_profile_generation_graph(llm: BaseLanguageModel, checkpointer: BaseCheckpointSaver):
    ...
    # profile_builder doesn't seem to need llm based on original code
